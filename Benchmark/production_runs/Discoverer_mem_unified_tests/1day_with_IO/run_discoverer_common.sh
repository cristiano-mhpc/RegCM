...
RUN_ROOT=$REGCM_ROOT/Benchmark/production_runs/Discoverer_mem_unified_tests/1day_with_IO
...
export REGCM_EXE=/valhalla/projects/ehpc-ben-2026b06-085/tchristian/work/RegCM/bin/mem_unified/regcmMPICLM45
...
echo "input/output symlinks, mem:unified binary, local namelist, and $DATA_ROOT/RCMDATA are present."
echo
