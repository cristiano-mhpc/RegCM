...
plot 'timing_v2.dat' using 2:xtic(1) title '1proc/GPU', \
     '' using 3 title '2proc/GPU', \
     '' using 4 title '4proc/GPU', \
     '' using 5 title '8proc/GPU', \
     '' using 6 title '16proc/GPU'
