...
OUTDIR="${PERF_OUTDIR:-$SCRATCH/perf/with_IO/16gpus_16proc/perf_${SLURM_JOB_ID}}" 
mkdir -p "$OUTDIR" 
...
# Launch the binary
exec perf record "${common_args[@]}" -- $BINDIR/regcmMPICLM45_OPENACC_STDPAR EURR-3_namelist.in 
